...
class ConcentrationDataReader:
    ...
    def __init__(self, logger, group_id):
        ...
        self.plate_layout_mapping_type_1_3 = {}
        self.plate_layout_mapping_type_1_10 = {}
        ...
        print("Data filenames: ", self.glomax_1_3_filename, self.glomax_1_10_filename)
    ...
    def extract_layout_data(self):
        ...
        for data in layout_data[1:]:
            ...
            if "1-10" in well_type:
                self.plate_layout_mapping_type_1_10[destination_well] = source_well
            elif "1-3" in well_type:
                self.plate_layout_mapping_type_1_3[destination_well] = source_well
            else:
                raise ProcessingError("Error reading Glomax layout mapping")

        for key, value in self.plate_layout_mapping_type_1_10.items():
            self.logger.debug("key: {}, value: {}".format(key, value))
        self.logger.debug("=================================================================\n")
        for key, value in self.plate_layout_mapping_type_1_3.items():
            self.logger.debug("key: {}, value {}".format(key, value))
    ...
    def extract_concentration_data(self):
        ...
        for data in conc_data:
            if len(data) >= 5:
                ...
                #self.logger.debug("first_field_value: {}, fifth_field_value: {}"
                #                  .format(first_field_value, fifth_field_value))
...
class GlomaxConcentrationLoaderMgr:
    ...
    def build_list_of_analyte_uris(self):
        ...
        for ioutput_elem in ioutput_elements:
            ...
            #if output_elem_type == "ResultFile" and output_elem_generation_type == "PerAllInputs":
...
def main():
    ...
    exit_msg = None
    try:
        glomax_conc_loader_mgr = GlomaxConcentrationLoaderMgr(logger, gau_interface,
